...
ACTSKFTrackingProc::ACTSKFTrackingProc()
  ...
  registerProcessorParameter(
      "RunKF",
      "Run track fitting using KF.", _runKF, _runKF);
  ...
  // KF configuration
  registerProcessorParameter("KF_Chi2CutOff",
                             "Maximum local chi2 contribution.",
                             _KF_chi2CutOff, _KF_chi2CutOff);

  // registerProcessorParameter(
  //     "KF_NumMeasurementsCutOff",
  //     "Maximum number of associated measurements on a single surface.",
  //     _KF_numMeasurementsCutOff, _KF_numMeasurementsCutOff);
...
void ACTSKFTrackingProc::processEvent(LCEvent *evt) {
  ...
  //      {_KF_chi2CutOff, (std::size_t)(_KF_numMeasurementsCutOff)}}};
  Acts::MeasurementSelector::Config measurementSelectorCfg = {
    {Acts::GeometryIdentifier(), {_KF_chi2CutOff}}};
  ...
  // HERE STARTED THE LOOP OVER ALL SEEDS
  // //
  ...
  streamlog_out(DEBUG) << "Seed Paramemeters" << std::endl
                        << paramseed << std::endl;
  // }
  /// HERE ENDED THE LOOP OVER ALL SEEDS
